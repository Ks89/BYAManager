...
import it.stefanocappa.gui.kcomponent.KViewPort;
...
public final class MainFrame extends KFrame implements Runnable {
	...
	public static JButton getAddLista() {
		return MainFrame.addLista;
	}

	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public static JComboBox<String> getListaDispositivi() {
		return MainFrame.listaDispositivi;
	}

	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public static JComboBox<String> getListaFirmware() {
		return MainFrame.listaFirmware;
	}

	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public static JComboBox<String> getOsList() {
		return MainFrame.osList;
	}

	@java.lang.SuppressWarnings("all")
	@javax.annotation.Generated("lombok")
	public static JComboBox<String> getItunesList() {
		return MainFrame.itunesList;
	}
}
