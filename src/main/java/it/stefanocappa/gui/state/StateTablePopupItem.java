...
import it.stefanocappa.gui.kcomponent.KPopupMenu;
...
public class StateTablePopupItem {
	...
	public void setPopupState(int status) {
		...
		case VALIDATION: 
		//se validation o altri status fa sempre quello in default (perche' non c'e' il break)
