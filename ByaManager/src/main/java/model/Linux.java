...
public class Linux extends OperativeSystem implements UnixCompatibileOs, AllCompatibleOs {
	public Linux(String platform) {
	...
	public final void generateCompleteName(String platform) {
		super.setCompleteName("Linux " + super.getArchitecture() + "bit (x" + super.getArchitecture() + ")");
	}

	@Override
	public final void generateShortName(String platform) {
		super.setShortName("Lnx" + super.getArchitecture());

	}

	@Override
	public final void generateArchitecture(String platform) {
		if(platform.equals("l32")) {
